...
export default function ComplianceDashboardPageEnhanced() {
  ...
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden rounded-xl bg-gradient-to-r from-teal-600 via-emerald-500 to-green-500 p-6 text-white shadow-lg">
        <div className="absolute -right-10 -top-10 h-40 w-40 rounded-full bg-white/10 blur-2xl" />
        <div className="absolute -bottom-10 -left-10 h-40 w-40 rounded-full bg-white/10 blur-2xl" />
      ...
      {/* Compliance Overview with StatsCard and Animations */}
      <StaggeredList className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <StaggeredItem>
          <Card className="hover:shadow-lg transition-all duration-300 border-green-200 bg-green-50/50">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Compliant Checks</CardTitle>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-green-600">
                <NumberCounter to={compliantCount} duration={1.5} />
              </div>
        ...
        <StaggeredItem>
          <Card className="hover:shadow-lg transition-all duration-300 border-yellow-200 bg-yellow-50/50">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-yellow-600">
                <NumberCounter to={minorIssuesCount} duration={1.5} />
              </div>
              <p className="text-xs text-muted-foreground mt-1">
                Action recommended
              </p>
        ...
        <StaggeredItem>
          <Card className="hover:shadow-lg transition-all duration-300 border-red-200 bg-red-50/50">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-red-600">
                <NumberCounter to={majorIssuesCount} duration={1.5} />
              </div>
              <p className="text-xs text-muted-foreground mt-1">
