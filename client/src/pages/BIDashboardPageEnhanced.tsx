...
export default function BIDashboardPageEnhanced() {
  ...
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden rounded-xl bg-gradient-to-r from-indigo-600 via-purple-500 to-pink-500 p-6 text-white shadow-lg">
      ...
      {/* KPIs with StatsCard and Animations */}
        ...
        {kpis.length === 0 ? (
          ...
          <StaggeredList className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {kpis.map((kpi, index) => {
              ...
              const isRevenue = kpi.metric.toLowerCase().includes('revenue');
        ...
        <Card aria-label="Active Alerts">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              Active Alerts (<NumberCounter to={alerts.filter(a => !a.resolved).length} duration={0.5} />)
            </CardTitle>
          </CardHeader>
          <CardContent>
