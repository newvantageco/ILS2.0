...
export const EXAM_TEMPLATES: ExamTemplate[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        title: "Visual Acuity",
        fields: [
          { id: "vaODUnaided", label: "VA R Unaided", type: "text", placeholder: "6/6" },
          { id: "vaOSUnaided", label: "VA L Unaided", type: "text", placeholder: "6/6" },
          { id: "vaODAided", label: "VA R Aided", type: "text", placeholder: "6/6" },
          { id: "vaOSAided", label: "VA L Aided", type: "text", placeholder: "6/6" },
      ...
      },
      {
        ...
        title: "Refraction",
        fields: [
          { id: "odSphere", label: "R Sphere", type: "text", placeholder: "-1.25" },
          { id: "odCylinder", label: "R Cylinder", type: "text", placeholder: "-0.50" },
          { id: "odAxis", label: "R Axis", type: "number", placeholder: "90" },
          { id: "osSphere", label: "L Sphere", type: "text", placeholder: "-1.25" },
          { id: "osCylinder", label: "L Cylinder", type: "text", placeholder: "-0.50" },
          { id: "osAxis", label: "L Axis", type: "number", placeholder: "90" },
        ],
      },
      {
        id: "eye-health",
        ...
        fields: [
          { id: "pupilsOD", label: "Pupils R", type: "text", placeholder: "PERRL" },
          { id: "pupilsOS", label: "Pupils L", type: "text", placeholder: "PERRL" },
          { id: "iopOD", label: "IOP R (mmHg)", type: "number", placeholder: "15" },
          { id: "iopOS", label: "IOP L (mmHg)", type: "number", placeholder: "15" },
          { id: "anteriorSegmentOD", label: "Anterior Segment R", type: "textarea", placeholder: "Clear cornea, deep AC, clear lens" },
          { id: "anteriorSegmentOS", label: "Anterior Segment L", type: "textarea", placeholder: "Clear cornea, deep AC, clear lens" },
          { id: "fundusOD", label: "Fundus R", type: "textarea", placeholder: "Healthy disc, vessels, macula" },
          { id: "fundusOS", label: "Fundus L", type: "textarea", placeholder: "Healthy disc, vessels, macula" },
        ],
      },
      {
        id: "assessment",
    ...
    sections: [
      {
        ...
        fields: [
          ...
          { id: "brandOD", label: "Brand R", type: "text" },
          { id: "brandOS", label: "Brand L", type: "text" },
      ...
      },
      {
        ...
        title: "Keratometry",
        fields: [
          { id: "kODFlat", label: "K R Flat", type: "text", placeholder: "42.50" },
          { id: "kODSteep", label: "K R Steep", type: "text", placeholder: "43.00" },
          { id: "kODAxis", label: "K R Axis", type: "number", placeholder: "180" },
          { id: "kOSFlat", label: "K L Flat", type: "text", placeholder: "42.50" },
          { id: "kOSSteep", label: "K L Steep", type: "text", placeholder: "43.00" },
          { id: "kOSAxis", label: "K L Axis", type: "number", placeholder: "180" },
        ],
      },
      {
        id: "trial-lens",
        ...
        fields: [
          { id: "trialBrandOD", label: "Trial Brand R", type: "text" },
          { id: "trialPowerOD", label: "Trial Power R", type: "text" },
          { id: "trialBcOD", label: "Trial BC R", type: "text" },
          { id: "trialDiameterOD", label: "Trial Diameter R", type: "text" },
          { id: "fitOD", label: "Fit Assessment R", type: "textarea" },
          { id: "trialBrandOS", label: "Trial Brand L", type: "text" },
          { id: "trialPowerOS", label: "Trial Power L", type: "text" },
          { id: "trialBcOS", label: "Trial BC L", type: "text" },
          { id: "trialDiameterOS", label: "Trial Diameter L", type: "text" },
          { id: "fitOS", label: "Fit Assessment L", type: "textarea" },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        fields: [
          { id: "iopOD", label: "IOP R (mmHg)", type: "number" },
          { id: "iopOS", label: "IOP L (mmHg)", type: "number" },
          { id: "cctOD", label: "CCT R (μm)", type: "number" },
          { id: "cctOS", label: "CCT L (μm)", type: "number" },
          { id: "cdRatioOD", label: "C/D Ratio R", type: "text", placeholder: "0.3" },
          { id: "cdRatioOS", label: "C/D Ratio L", type: "text", placeholder: "0.3" },
        ],
      },
      {
        id: "assessment",
