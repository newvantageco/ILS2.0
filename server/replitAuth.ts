...
const getOidcConfig = memoize(
  async () => {
    // Use local configuration when REPLIT_DOMAINS is not provided
...
const isOidcConfiguration = (value: unknown): value is client.Configuration => {
